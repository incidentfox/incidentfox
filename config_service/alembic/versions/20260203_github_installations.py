...
def upgrade():
    ...
    op.create_table(
        ...
        # IncidentFox org/team linkage
        sa.Column(
            "org_id",
            sa.String(255),
            nullable=True,
            index=True,
            comment="IncidentFox org ID (set during setup)",
        ),
        sa.Column(
            "team_node_id",
            sa.String(255),
            nullable=True,
            index=True,
            comment="IncidentFox team node ID (set during setup)",
        ),
    ...
    # Index for looking up installations by IncidentFox org/team
    op.create_index(
