    ...
    return {
        "agents": {
            "planner": {
                "enabled": True,
                "name": "Planner",
                "model": {"name": "anthropic/claude-sonnet-4-5-20250929", "temperature": 0.3},
            ...
            "investigation": {
                ...
                "model": {"name": "anthropic/claude-sonnet-4-5-20250929", "temperature": 0.4},
                "prompt": {"system": ""},
                "max_turns": 20,
            ...
            "metrics": {
                "enabled": True,
                "name": "Metrics Agent",
                "model": {"name": "anthropic/claude-sonnet-4-5-20250929", "temperature": 0.2},
                "prompt": {"system": ""},
                "max_turns": 15,
                "tools": {"enabled": ["*"], "disabled": []},
                "sub_agents": [],
