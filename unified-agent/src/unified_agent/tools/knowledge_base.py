...
# Register tools
register_tool("search_knowledge_base", search_knowledge_base)
register_tool("ask_knowledge_base", ask_knowledge_base)
register_tool("get_knowledge_context", get_knowledge_context)
register_tool("list_knowledge_trees", list_knowledge_trees)
register_tool("search_for_incident", search_for_incident)
register_tool("query_service_graph", query_service_graph)
register_tool("teach_knowledge_base", teach_knowledge_base)
register_tool("find_similar_past_incidents", find_similar_past_incidents)
