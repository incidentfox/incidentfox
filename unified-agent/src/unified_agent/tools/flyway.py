...
def _run_flyway_command(
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "flyway"})


def _parse_flyway_info_output(output: str) -> str:
...
@function_tool
def flyway_clean(confirm: bool = False) -> str:
    """
...
# Register tools
register_tool("flyway_info", flyway_info)
register_tool("flyway_validate", flyway_validate)
register_tool("flyway_migrate", flyway_migrate)
register_tool("flyway_repair", flyway_repair)
register_tool("flyway_baseline", flyway_baseline)
register_tool("flyway_clean", flyway_clean)
register_tool("flyway_undo", flyway_undo)
