...
# Register tools
register_tool("query_log_analytics", query_log_analytics)
register_tool("query_azure_resource_graph", query_azure_resource_graph)
register_tool("get_application_insights_traces", get_application_insights_traces)
register_tool("get_azure_monitor_metrics", get_azure_monitor_metrics)
register_tool("get_azure_monitor_alerts", get_azure_monitor_alerts)
register_tool("describe_azure_vm", describe_azure_vm)
register_tool("list_azure_vms", list_azure_vms)
register_tool("describe_aks_cluster", describe_aks_cluster)
register_tool("list_aks_clusters", list_aks_clusters)
register_tool("describe_azure_function", describe_azure_function)
register_tool("list_azure_functions", list_azure_functions)
register_tool("describe_azure_sql_database", describe_azure_sql_database)
register_tool("list_azure_sql_databases", list_azure_sql_databases)
register_tool("describe_cosmos_db_account", describe_cosmos_db_account)
register_tool("query_azure_cost_management", query_azure_cost_management)
register_tool("get_azure_advisor_recommendations", get_azure_advisor_recommendations)
register_tool("list_azure_backup_vaults", list_azure_backup_vaults)
register_tool("get_azure_backup_status", get_azure_backup_status)
register_tool("describe_azure_vnet", describe_azure_vnet)
register_tool("get_azure_nsg_rules", get_azure_nsg_rules)
