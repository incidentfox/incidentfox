...
def _calculate_baseline(values: list[float]) -> str:
...
# Register tools
register_tool("compute_metric_baseline", compute_metric_baseline)
register_tool("suggest_alert_thresholds", suggest_alert_thresholds)
register_tool("generate_alert_rules", generate_alert_rules)
