...
def _run_alembic_command(
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "alembic"})


def _parse_alembic_history(output: str) -> str:
...
@function_tool
def alembic_history(verbose: bool = False, limit: int | None = None) -> str:
    """
...
@function_tool
def alembic_stamp(revision: str) -> str:
    """
...
@function_tool
def alembic_show(revision: str) -> str:
    """
...
# Register tools
register_tool("alembic_current", alembic_current)
register_tool("alembic_history", alembic_history)
register_tool("alembic_heads", alembic_heads)
register_tool("alembic_branches", alembic_branches)
register_tool("alembic_upgrade", alembic_upgrade)
register_tool("alembic_downgrade", alembic_downgrade)
register_tool("alembic_stamp", alembic_stamp)
register_tool("alembic_check", alembic_check)
register_tool("alembic_show", alembic_show)
