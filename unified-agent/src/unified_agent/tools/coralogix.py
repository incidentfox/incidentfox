...
def get_coralogix_config() -> str:
    ...
    return {"error": "coralogix not configured"}
...
# Register tools
register_tool("get_coralogix_config", get_coralogix_config)
register_tool("search_coralogix_logs", search_coralogix_logs)
register_tool("get_coralogix_error_logs", get_coralogix_error_logs)
register_tool("get_coralogix_alerts", get_coralogix_alerts)
register_tool("query_coralogix_metrics", query_coralogix_metrics)
register_tool("search_coralogix_traces", search_coralogix_traces)
register_tool("get_coralogix_service_health", get_coralogix_service_health)
register_tool("list_coralogix_services", list_coralogix_services)
register_tool("coralogix_get_alert_rules", coralogix_get_alert_rules)
register_tool("coralogix_get_alert_history", coralogix_get_alert_history)
