...
# Register tools
register_tool("get_snowflake_config", get_snowflake_config)
register_tool("run_snowflake_query", run_snowflake_query)
register_tool("get_recent_incidents", get_recent_incidents)
register_tool("get_incident_customer_impact", get_incident_customer_impact)
register_tool("get_deployment_incidents", get_deployment_incidents)
register_tool("get_customer_info", get_customer_info)
register_tool("get_incident_timeline", get_incident_timeline)
register_tool("search_incidents_by_service", search_incidents_by_service)
register_tool("snowflake_list_tables", snowflake_list_tables)
register_tool("snowflake_describe_table", snowflake_describe_table)
register_tool("snowflake_bulk_export", snowflake_bulk_export)
register_tool("get_snowflake_schema", get_snowflake_schema)
