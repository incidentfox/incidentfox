...
def _run_prisma_command(
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "prisma"})


@function_tool
def prisma_migrate_status() -> str:
    """
...
@function_tool
def prisma_db_push(accept_data_loss: bool = False) -> str:
    """
...
# Register tools
register_tool("prisma_migrate_status", prisma_migrate_status)
register_tool("prisma_migrate_deploy", prisma_migrate_deploy)
register_tool("prisma_migrate_reset", prisma_migrate_reset)
register_tool("prisma_migrate_resolve", prisma_migrate_resolve)
register_tool("prisma_migrate_diff", prisma_migrate_diff)
register_tool("prisma_db_push", prisma_db_push)
register_tool("prisma_db_pull", prisma_db_pull)
register_tool("prisma_validate", prisma_validate)
register_tool("prisma_format", prisma_format)
