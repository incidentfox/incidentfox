...
def _get_schema_registry_config() -> str:
    ...
    return {"error": "schema_registry not configured"}
...
@function_tool
def schema_registry_list_subjects() -> str:
    """
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "schema_registry_list_subjects"})
...
def schema_registry_get_schema(
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "schema_registry_get_schema"})


@function_tool
def schema_registry_get_versions(subject: str) -> str:
    """
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "schema_registry_get_versions"})
...
def schema_registry_check_compatibility(
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "schema_registry_check_compatibility"})
...
def schema_registry_register_schema(
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "schema_registry_register_schema"})
...
def schema_registry_get_compatibility_level(
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "schema_registry_get_compatibility_level"})
...
def schema_registry_set_compatibility_level(
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "schema_registry_set_compatibility_level"})
...
def schema_registry_delete_subject(
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "schema_registry_delete_subject"})
...
# Register tools
register_tool("schema_registry_list_subjects", schema_registry_list_subjects)
register_tool("schema_registry_get_schema", schema_registry_get_schema)
register_tool("schema_registry_get_versions", schema_registry_get_versions)
register_tool("schema_registry_check_compatibility", schema_registry_check_compatibility)
register_tool("schema_registry_register_schema", schema_registry_register_schema)
register_tool("schema_registry_get_compatibility_level", schema_registry_get_compatibility_level)
register_tool("schema_registry_set_compatibility_level", schema_registry_set_compatibility_level)
register_tool("schema_registry_delete_subject", schema_registry_delete_subject)
