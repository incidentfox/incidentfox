...
def gh_ost_run(
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "gh_ost"})


@function_tool
def gh_ost_cut_over(postpone_file: str | None = None) -> str:
    """
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "gh_ost_cut_over"})


@function_tool
def gh_ost_panic(panic_file: str | None = None) -> str:
    """
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "gh_ost_panic"})
...
def pt_online_schema_change(
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "pt_online_schema_change"})
...
def osc_estimate_time(
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "osc_estimate"})
...
# Register tools
register_tool("gh_ost_run", gh_ost_run)
register_tool("gh_ost_cut_over", gh_ost_cut_over)
register_tool("gh_ost_panic", gh_ost_panic)
register_tool("pt_online_schema_change", pt_online_schema_change)
register_tool("osc_estimate_time", osc_estimate_time)
