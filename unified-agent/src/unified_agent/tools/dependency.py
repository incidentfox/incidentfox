...
# Register tools
register_tool("get_service_dependencies", get_service_dependencies)
register_tool("get_service_dependents", get_service_dependents)
register_tool("get_blast_radius", get_blast_radius)
register_tool("get_dependency_graph_stats", get_dependency_graph_stats)
