...
@function_tool
def postgres_list_tables(schema: str | None = None) -> str:
    """
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "postgres_list_tables"})
...
def postgres_describe_table(
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "postgres_describe_table"})
...
def postgres_execute_query(
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "postgres_execute_query"})
...
def postgres_list_indexes(
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "postgres_list_indexes"})
...
def postgres_list_constraints(
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "postgres_list_constraints"})
...
def postgres_get_table_size(
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "postgres_get_table_size"})


@function_tool
def postgres_get_locks() -> str:
    """
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "postgres_get_locks"})


@function_tool
def postgres_get_replication_status() -> str:
    """
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "postgres_get_replication_status"})


@function_tool
def postgres_get_long_running_queries(min_duration_seconds: int = 60) -> str:
    """
    ...
    try:
        ...
        return json.dumps({"ok": False, "error": "postgres_get_long_running_queries"})
...
register_tool("postgres_execute_query", postgres_execute_query)
register_tool("postgres_list_indexes", postgres_list_indexes)
register_tool("postgres_list_constraints", postgres_list_constraints)
register_tool("postgres_get_table_size", postgres_get_table_size)
register_tool("postgres_get_locks", postgres_get_locks)
register_tool("postgres_get_replication_status", postgres_get_replication_status)
register_tool("postgres_get_long_running_queries", postgres_get_long_running_queries)
