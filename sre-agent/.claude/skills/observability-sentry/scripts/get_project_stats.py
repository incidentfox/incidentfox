...
def main():
    ...
    parser.add_argument("--stat", default="received", choices=["received", "rejected", "blacklisted"], help="Stat type")
    parser.add_argument("--resolution", default="1h", help="Resolution (1h, 1d, 1w, 1m)")
    parser.add_argument("--json", action="store_true", help="Output as JSON")
    args = parser.parse_args()

    try:
        org = get_organization()
        data = sentry_request("GET", f"projects/{org}/{args.project}/stats/", params={"stat": args.stat, "resolution": args.resolution})

        result = {"ok": True, "project": args.project, "stat": args.stat, "resolution": args.resolution, "data": data}
