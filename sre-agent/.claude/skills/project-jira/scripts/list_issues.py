...
def main():
    ...
    try:
        ...
        data = jira_request(
            "GET", "/search",
            params={"jql": jql, "maxResults": args.max_results, "fields": "summary,status,issuetype,assignee,created"},
        )
        ...
        result = {"ok": True, "project": args.project, "issues": issues, "count": len(issues)}
